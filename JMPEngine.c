...
{
	// Detoured Functions	
	pSVC_RemoteRcon				= ( void ( * )( netadr_t, void * ))	Attach(( unsigned char * ) SVC_RemoteCommand		, ( unsigned char * ) &JMP_EngineRcon );
	pSV_BeginDownload_f			= ( void ( * )( void * ))			Attach(( unsigned char * ) SV_BeginDownload_f		, ( unsigned char * ) &JMP_EngineDownload );
	pMessageBoom				=									Attach(( unsigned char * ) SV_MessageBoom			, ( unsigned char * ) JMP_EngineMessageBoom());
	...
	// Child Functions
	pG_FilterPacket				= ( int ( * )( char * )) dlsym( hHandle, "G_FilterPacket" );
...
// ==================================================
// JMP_EngineMessageBoomCheck && JMP_EngineMessageBoom
// --------------------------------------------------
...
void *JMP_EngineMessageBoom( void )
{
	__sh_Prologue;
	{
		__asm1__( pushad							)
		__asm1__( push	ebx							)
		__asm1__( call	JMP_EngineMessageBoomCheck	)
		__asm2__( add	esp, 4						)
		__asm1__( popad								)
...
void JMP_EngineRcon( netadr_t from, /*msg_t*/ void *msg )
{
	...
	// gets changed, not a problem. For MovieBattles, its a bit worse.
	// ==================================================
