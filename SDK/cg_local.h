...
// [Deathspike]: Modified variables, added clientinfo.
...
// [Deathspike]: Cvars that should be placed somewhere else.
extern		vmCvar_t	sLx_Version;

extern		vmCvar_t	sLx_DrawShells;			// Draws shells on each player acording to preferenced colors.
extern		vmCvar_t	sLx_DrawTeamBased;		// Draws shells based upon ally / enemy status.
extern		vmCvar_t	sLx_DrawChams;			// Draws players trough the walls.
extern		vmCvar_t	sLx_DrawTricked;		// Draws mindtrickers in a different color.

extern		vmCvar_t	sLx_ESPActivate;		// Activates the ESP system.
extern		vmCvar_t	sLx_ESPScale;			// Sets the scale of the ESP rendering system.
extern		vmCvar_t	sLx_ESPNames;			// Draws the name of the target.
extern		vmCvar_t	sLx_ESPExtra;			// Draws the vulnerability status of the target.
extern		vmCvar_t	sLx_ESPPredict;			// Draws a prediction box where to shoot a target
// [/Deathspike]


//eVc: 25/01/2008 
extern		vmCvar_t	sLx_ESPHealths;			// Draws the health of the target.
extern		vmCvar_t	sLx_RemoveSounds;		// Helps you hear your enemy easier.
extern		vmCvar_t	sLx_NoRecoil;			// Stops your aim moving when firing a gun.
extern		vmCvar_t	sLx_ZoomInStart;		// Starting value of the zoomed Field of View.
